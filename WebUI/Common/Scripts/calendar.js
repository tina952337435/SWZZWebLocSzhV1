...
Calendar.prototype = {
    ...
    init: function () {
        ...
        el.on("click", ".calendar-cell", function (e) {
            ...
            var month = parseInt(cellDate.split("年")[1].split("月")[0]);
            var date = parseInt(cellDate.split("年")[1].split("月")[1].split("日")[0]);
            $.data(myData, "DD_TM", year + "-" + month + "-" + date);
            month = month - 1;
            if (opts.mode == "year") {
    ...
    getViewDate: function (viewDate) {
        ...
        for (var i = 0; i < data.length; i++) {
            ...
            var DD_TM = new Date((item.dd_TM)).format("yyyy-MM-dd")

            var start = me._getDateByString(DD_TM);
            //console.error(DD_TM);
        ...
        for (var i = 0; i < 4; i++) {
            ...
            for (var l = 0; l < 3; l++) {
                ...
                if (showEvent && viewData[renderMonth]) {
                    html = ' style="background: url(/Common/images/sign_have.gif) no-repeat top;" ';
                ...
                s += '<div class="calendar-value" ' + html+'>' + (renderMonth + 1) + '月</div>';
    ...
    _refreshCalendar: function (newDate) {
        ...
        for (var i = 0; i < 6; i++) {
            ...
            for (var l = 0; l < 7; l++) {
                ...
                s += '<div class="calendar-date">';
                s += '<div class="calendar-value" ' + html+'>' + date + '</div>';
                s += '<div class="calendar-content"><ul class="events">'
                //if (showEvent && viewData[date] && renderDate.getMonth() == newDate.getMonth()) {
...
//		{ startDate: "2019-4-4", name: "请假" },
//		{ startDate: "2019-5-5", name: "已打卡" },
//		{ startDate: "2019-3-6", name: "已打卡" },
//		{ startDate: "2019-7-7", name: "事件" },
//		{ startDate: "2019-5-8", name: "请假" },
//		{ startDate: "2019-6-9", name: "已打卡" },
//		{ startDate: "2019-7-10", name: "事件" },
//		{ startDate: "2019-8-11", name: "事件" },
//		{ startDate: "2019-9-12", name: "事件" },
//		{ startDate: "2019-10-13", name: "事件" },		
//		{ startDate: "2019-11-7", name: "事件" },
//		{ startDate: "2019-12-8", name: "请假" },
//		{ startDate: "2020-1-9", name: "已打卡" },
//		{ startDate: "2020-2-10", name: "事件" },
//		{ startDate: "2020-3-11", name: "事件" },
//		{ startDate: "2020-4-12", name: "事件" },
//		{ startDate: "2020-5-13", name: "事件" },	  
//		{ startDate: "2020-6-7", name: "事件" },
//		{ startDate: "2020-7-8", name: "请假" },
//		{ startDate: "2020-8-9", name: "已打卡" },
//		{ startDate: "2020-9-10", name: "事件" },
//		{ startDate: "2020-10-11", name: "事件" },
//		{ startDate: "2020-11-12", name: "事件" },
//		{ startDate: "2020-12-13", name: "事件" }, 
