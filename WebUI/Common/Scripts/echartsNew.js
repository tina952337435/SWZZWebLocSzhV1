!function (e, t) {
    ...
    !function () {
        ...
        return o.prototype = {
            type: "element", name: "", __zr: null, ignore: !1, clipPath: null, drift: function (e, t) {
        ...
        return m.prototype = {
            constructor: m, _lineDash: null, _dashOffset: 0, _dashIdx: 0, _dashSum: 0, getContext: function () {
                return this._ctx
        ...
        return r.prototype = {
            constructor: r, type: "path", __dirtyPath: !0, strokeContainThreshold: 5, brush: function (e) {
                e.save();
        ...
        return i.extend(e("../../model/Model").prototype, e("./barItemStyle")), e("../../echarts").extendChartView({
            type: "bar", render: function (e, t, i) {
        ...
        var i = e("zrender/core/util"), r = e("./AxisBuilder"), n = e("../helper/SelectController"),
            a = ["axisLine", "axisLabel", "axisTick", "axisName"], o = e("../../echarts").extendComponentView({
                type: "parallelAxis", _selectController: null, render: function (e, n, o, s) {
            ...
            c = e("zrender/graphic/LinearGradient"), u = e("./helper"), h = a.each, d = r.extend({
                type: "visualMap.continuous", init: function () {
                    ...
                    var h = {
                        ...
                        silent: !0,
                        style: {x: 0, y: 0, text: "", textBaseline: "middle", textFont: d.getFont(), fill: d.getTextColor()}
                    });
                    this.group.add(p);
                    var f = this._shapes;
                    ...
                    return {barColor: new c(0, 0, 1, 1, n), barPoints: o, handlesColor: [n[0].color, n[n.length - 1].color]}
