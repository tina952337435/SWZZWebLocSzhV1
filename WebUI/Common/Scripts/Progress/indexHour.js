...
//    SetProgressTime(null, "2019/02/27 0:00:00", "2019/03/02 08:00:00")
//});
var _index = 0;//进度
...
function SetProgressTime(fun, startTime, endTime) {
    ...
    function getDateDiff(date1, date2) {
        ...
        alert(d1.format("yyyy-MM-dd HH:mm:ss"));
        alert(d2.format("yyyy-MM-dd HH:mm:ss"));
    ...
    var dateNum = daysBetween(firstStart, lastEnd);
    var str = '';
...
function SetTime1(value) {
    ...
    indexStart2 = startDate.format("dd日HH时");
    $(".timecode").html(indexStart2);
    if (window.parent.currentTime) {
        currentTime = indexStart;
    }
