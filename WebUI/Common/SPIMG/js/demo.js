...
var heightsp = document.documentElement.clientHeight;
var widthsp = document.documentElement.clientWidth;
var wsp = widthsp - 535;
var hsp = heightsp - 70;
$(function () {
    // 检查插件是否已经安装过
    if (-1 == WebVideoCtrl.I_CheckPluginInstall()) {
        window.open("/Common/SPIMG/js/WebComponents.exe");
        alert("您还未安装过插件，双击开发包目录里的WebComponents.exe安装！");
        return;
    }

    // 初始化插件参数及插入插件
    WebVideoCtrl.I_InitPlugin(wsp, hsp, {
        iWndowType: 2,
