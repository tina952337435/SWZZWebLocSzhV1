define(["dojo/_base/declare", "dojo/_base/lang", "esri/geometry/Point", "esri/geometry/ScreenPoint"], function (e, t, n, i) {
    return e("Echarts3Layer", null, {
        ...
        constructor: function (e, t) {
            ...
            n.style.position = "absolute", n.style.height = e.height + "px", n.style.width = e.width + "px", n.style.top = 0, n.style.left = 0, e._layersDiv.appendChild(n), this._init(e, t)
        },
        _init: function (e, t) {
            ...
            o._map = e, o._ec = t, o.getEchartsContainer = function () {
                ...
                o._map.on("zoom-end", function (e) {
                    ...
                    o._mapOffset = [-parseInt(e.style.left) || 0, -parseInt(e.style.top) || 0], o._echartsContainer.style.left = o._mapOffset[0] + "px", o._echartsContainer.style.top = o._mapOffset[1] + "px",
                       function () {
