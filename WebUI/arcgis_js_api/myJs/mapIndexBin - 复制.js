...
require([
        ...
        "dojo/domReady!"
          ...
          //url = "http://112.25.70.13:6080/arcgis/rest/services/2015zhiban/MapServer";
          ...
          ////无背景
          //layer6 = new ArcGISDynamicMapServiceLayer("http://112.25.70.13:6080/arcgis/rest/services/hd_shp/MapServer", { useMapImage: true });
          ////有背景
          //layer7 = new ArcGISDynamicMapServiceLayer("http://112.25.70.13:6080/arcgis/rest/services/hd/MapServer", { useMapImage: true });
          ...
          //    var zoomFactor = e.zoomFactor;
          //    if (zoomFactor > 1) {
          //        if (zoom > 8 && !_zoomIned_) {
          //            AutoZoomIn(false);
          //        }
          //    } else if (zoomFactor < 1) {
          //        if (zoom < 9 && !_zoomOuted_) {
          //            AutoZoomOut(false);
          //        }
          //    }
          //});
...
function AutoZoomOut() {
    ...
    $("#map-tl").animate({ right: "22%" }, 300);
    $("#map-toolbar").animate({
        top: '100px',
        right: "22%"
    }, 300);
    $("#map-zhtl").animate({ right: "23%" }, 300);
    $("#map-reset").animate({ right: "25%" }, 300);
    $("#TLDiv").animate({ right: "25%" }, 300);
    //map.setCenter({
    //    x: _config_.center.x,
    //    y: _config_.center.y,
    //    sr: _config_.center.sr
        ...
        //var list = [28, 29, 30, 31, 32, 33, 34, 35];
            ...
            if (list.length > 0) {
                for (numII = 0; numII < list.length; numII++) {
                   // console.log(numII);
                    //var layerUrl = "http://112.25.70.13:6080/arcgis/rest/services/hd/MapServer/" + list[numII];
                    var layerUrl = "http://112.25.70.13:6080/arcgis/rest/services/2015zhiban/MapServer/" + list[numII];
