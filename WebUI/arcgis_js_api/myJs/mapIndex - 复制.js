...
require([
    ...
    layer1 = new ArcGISDynamicMapServiceLayer("http://112.25.70.13:6080/arcgis/rest/services/zonghe/MapServer", {  useMapImage: false, id: "Layer0", visible: false });
    //河道
    //layer2 = new ArcGISDynamicMapServiceLayer("http://112.21.188.187:6080/arcgis/rest/services/jkq_hd/MapServer", { useMapImage: false });
    layer2 = new ArcGISDynamicMapServiceLayer("http://112.25.70.13:6080/arcgis/rest/services/zonghe/MapServer", { useMapImage: false, id: "Layer1", visible: false });

    //圩区
    //layer3 = new ArcGISDynamicMapServiceLayer("http://112.21.188.187:6080/arcgis/rest/services/jkq_wq/MapServer", { useMapImage: false });
    layer3 = new ArcGISDynamicMapServiceLayer("http://112.25.70.13:6080/arcgis/rest/services/zonghe/MapServer", {  useMapImage: false, id: "Layer2", visible: false });
    //大包围区
    //layer4 = new ArcGISDynamicMapServiceLayer("http://112.21.188.187:6080/arcgis/rest/services/jkq_sgnq/MapServer", { useMapImage: false });
    layer4 = new ArcGISDynamicMapServiceLayer("http://112.25.70.13:6080/arcgis/rest/services/zonghe/MapServer", {  useMapImage: false, id: "Layer3", visible: false });
    //乡镇
    //layer5 = new ArcGISDynamicMapServiceLayer("http://112.21.188.187:6080/arcgis/rest/services/jkq_xz/MapServer", { useMapImage: false });
    layer5 = new ArcGISDynamicMapServiceLayer("http://112.25.70.13:6080/arcgis/rest/services/zonghe/MapServer", {  useMapImage: false, id: "Layer4", visible: false });
    //无背景
    //layer6 = new ArcGISDynamicMapServiceLayer("http://112.25.70.13:6080/arcgis/rest/services/hd_shp/MapServer", { useMapImage: false });
    layer6 = new ArcGISDynamicMapServiceLayer("http://112.25.70.13:6080/arcgis/rest/services/zonghe/MapServer", { useMapImage: false, id: "Layer5", visible: false });
    //有背景
    //layer7 = new ArcGISDynamicMapServiceLayer("http://112.25.70.13:6080/arcgis/rest/services/hd/MapServer", { useMapImage: false });
    layer7 = new ArcGISDynamicMapServiceLayer("http://112.25.70.13:6080/arcgis/rest/services/zonghe/MapServer", {  useMapImage: false, id: "Layer6", visible: false });
    layer8 = new ArcGISDynamicMapServiceLayer("http://112.25.70.13:6080/arcgis/rest/services/zonghe/MapServer", {  useMapImage: false, id: "Layer7", visible: false });
    layer9 = new ArcGISDynamicMapServiceLayer("http://112.25.70.13:6080/arcgis/rest/services/zonghe/MapServer", {  useMapImage: false, id: "Layer8", visible: false });
    layer10 = new ArcGISDynamicMapServiceLayer("http://112.25.70.13:6080/arcgis/rest/services/zonghe/MapServer", {  useMapImage: false, id: "Layer9", visible: false });
    layer11 = new ArcGISDynamicMapServiceLayer("http://112.25.70.13:6080/arcgis/rest/services/zonghe/MapServer", {  useMapImage: false, id: "Layer10", visible: false });
    layer12 = new ArcGISDynamicMapServiceLayer("http://112.25.70.13:6080/arcgis/rest/services/zonghe/MapServer", {  useMapImage: false, id: "Layer11", visible: false });
    layer13 = new ArcGISDynamicMapServiceLayer("http://112.25.70.13:6080/arcgis/rest/services/zonghe/MapServer", {  useMapImage: false, id: "Layer12", visible: false });
    ...
    //城市防洪
    var agglist = [10];
    $.data(BinData, "Layer0", agglist);
    layer1.setVisibleLayers(agglist);
    map.addLayer(layer1);

    //圩区
    agglist = [11];
    $.data(BinData, "Layer1", agglist);
    layer2.setVisibleLayers(agglist,1);
    map.addLayer(layer2);
    layer2.setVisibility(true);

    //水闸
    agglist = [13];
    layer3.setVisibleLayers(agglist);
    $.data(BinData, "Layer2", agglist);
    map.addLayer(layer3);
    layer2.setVisibility(true);

    //泵站
    agglist = [14];
    layer4.setVisibleLayers(agglist);
    $.data(BinData, "Layer3", agglist);
    map.addLayer(layer4);
    layer4.setVisibility(true);

    //水库
    agglist = [15];
    $.data(BinData, "Layer4", agglist);
    layer5.setVisibleLayers(agglist);
    map.addLayer(layer5);

    //湖泊
    agglist = [16];
    $.data(BinData, "Layer5", agglist);
    layer6.setVisibleLayers(agglist);
    map.addLayer(layer6);
    //河道
    agglist = [17,18,19,20,21,22,23,24];
    $.data(BinData, "Layer6", agglist);
    layer7.setVisibleLayers(agglist);
    map.addLayer(layer7);
    //排污口
    agglist = [6];
    $.data(BinData, "Layer7", agglist);
    layer8.setVisibleLayers(agglist);
    map.addLayer(layer8);
    layer8.setVisibility(true);

    //取水口
    agglist = [7];
    $.data(BinData, "Layer8", agglist);
    layer9.setVisibleLayers(agglist);
    map.addLayer(layer9);
    layer9.setVisibility(true);
    //灌区
    agglist = [7];
    $.data(BinData, "Layer9", agglist);
    layer10.setVisibleLayers(agglist);
    map.addLayer(layer10);
    //水源地
    agglist = [8];
    $.data(BinData, "Layer10", agglist);
    layer11.setVisibleLayers(agglist);
    map.addLayer(layer11);
    //堤防
    agglist = [9];
    $.data(BinData, "Layer11", agglist);
    layer12.setVisibleLayers(agglist);
    map.addLayer(layer12);
    //行政
    agglist = [27,28];
    $.data(BinData, "Layer12", agglist);
    layer13.setVisibleLayers(agglist);
